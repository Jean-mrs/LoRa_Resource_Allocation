        ...
        if experiment == 6:  # HEURISTICA
            ...
            for sfs in range(0, 6):
                if (self.nodeid >= int(sfatual)) and (self.nodeid < int(Quantsf[sfs]) + int(sfatual)):
                    ...
                    self.sf = 7 + sfs
                    minX = sfs
                    if (self.nodeid >= int(sfatual)) and (self.nodeid < int(sfatual) + int((Quantsf[sfs]) / 8)):
                        self.freq = CF1
                        minY = 0
                        break
                        ...
                        minY = 5
                        break
                    elif (self.nodeid >= int(sfatual) + 6 * int((Quantsf[sfs]) / 8)) and (self.nodeid < int(sfatual) + 7 * int((Quantsf[sfs]) / 8)):
                        self.freq = CF7
                        minY = 6
                        break
